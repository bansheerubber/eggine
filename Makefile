...
CC = g++
CPPFLAGS = -O2 -Wall -Wno-switch -Wno-class-memaccess -Wno-delete-incomplete -Wno-attributes -Bsymbolic -fPIC -fno-semantic-interposition --static -std=c++17 -DGLM_EXT_INCLUDED -DGLFW_INCLUDE_VULKAN -DGLFW_EXPOSE_NATIVE_X11
soflags =
ldflags =
