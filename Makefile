target = game
cclibs = -lpthread -llitehtml -lgumbo -lGL -lglfw -ldl -lpng -lfreetype -leggscript -lfmt -lz -lopenal -lvorbis -lvorbisfile
...
CC = g++
CPPFLAGS = -O2 -Wall -Wno-switch -Wno-class-memaccess -Wno-delete-incomplete -Wno-attributes -Bsymbolic -fPIC -fno-semantic-interposition --static -std=c++17 -DEGGINE_DEVELOPER_MODE
soflags =
ldflags =
